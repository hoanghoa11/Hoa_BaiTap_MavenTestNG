...
public class Category {
    ...
    private By selectImage1 = By.xpath("//div[@title='giay.png']");
    ...
    public void addCategory(String categoryName) {
        ...
        WebUI.setText(searchParentCategory,"QuynhNN");
        WebUI.sleep(1);
        ...
        WebUI.setText(inputMetaTitle,"Giay kieu moi");
        WebUI.setText(inputMetaDescription,"Giay bong dep");
